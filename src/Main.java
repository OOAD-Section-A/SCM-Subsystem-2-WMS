...
//         catalog.put("SKU-GLASS-VASE", new wms.models.Product("P003", "SKU-GLASS-VASE", "Decorative Glass Vase", wms.models.ProductCategory.HIGH_VALUE));
// 
...
//             com.scm.packing.integration.warehouse.IWarehousePackingIntegration externalPackagingSystem = 
//                 new com.scm.packing.integration.warehouse.WarehousePackingIntegrationService(packingModel, packingFactory);
//                 
//             // 2. Init our WMS Services
//             wms.services.integration.IExternalPackingService packingAdapter = new wms.services.integration.PackagingSystemAdapter(externalPackagingSystem);
